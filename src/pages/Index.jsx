  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      <Card className="mb-8 bg-gradient-to-r from-purple-500 to-pink-500 text-white">
        <CardHeader>
          <CardTitle className="text-3xl font-bold">Welcome to Team Marc Agents Tools</CardTitle>
          <CardDescription className="text-lg text-white/80">
            This platform provides various tools and resources for Team Marc agents. Use the sidebar menu to navigate through different features.
          </CardDescription>
        </CardHeader>
      </Card>
